...
namespace PulseTrack.Application.Abstractions
{
    ...
    {
        Task<IReadOnlyList<Section>> ListByProjectAsync(Guid projectId, CancellationToken cancellationToken);
        ...
        Task ReorderAsync(Guid projectId, IReadOnlyList<Guid> orderedSectionIds, CancellationToken cancellationToken);
    }
}
