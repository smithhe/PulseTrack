...
namespace PulseTrack.Api.Endpoints.Sections
{
    public class ListSectionsEndpoint : EndpointWithoutRequest
    {
        ...
        public ListSectionsEndpoint(IMediator mediator) { _mediator = mediator; }
        ...
        public override async Task HandleAsync(CancellationToken ct)
        {
            ...
            IReadOnlyList<Section> sections = await _mediator.Send(new ListSectionsByProjectQuery(projectId), ct);
            HttpContext.Response.ContentType = "application/json";
            await JsonSerializer.SerializeAsync(HttpContext.Response.Body, sections, cancellationToken: ct);
        }
    }
}
