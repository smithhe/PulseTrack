...
namespace PulseTrack.Api.Endpoints.Items
{
    ...
    public class PinItemEndpoint : EndpointWithoutRequest
    {
        ...
        /// <summary>
        /// Creates a new instance of the PinItemEndpoint
        /// </summary>
        ...
        /// <summary>
        /// Handles the request to pin an item
        /// </summary>
        ...
        public override async Task HandleAsync(CancellationToken ct)
        {
            ...
            catch (Exception ex)
            {
                ...
                await JsonSerializer.SerializeAsync(
                    HttpContext.Response.Body,
                    new { error = "Failed to pin item", details = ex.Message },
                    cancellationToken: ct
                );
            }
        }
