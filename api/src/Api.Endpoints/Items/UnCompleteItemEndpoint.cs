...
{
    /// <summary>
    /// Endpoint for marking an item as uncompleted
    /// </summary>
    public class UnCompleteItemEndpoint : EndpointWithoutRequest
    {
        ...
        /// <summary>
        /// Creates a new instance of the UnCompleteItemEndpoint
        /// </summary>
        ...
        /// <summary>
        /// Handles the request to mark an item as uncompleted
        /// </summary>
        ...
        public override async Task HandleAsync(CancellationToken ct)
        {
            ...
            catch (Exception ex)
            {
                ...
                await JsonSerializer.SerializeAsync(
                    HttpContext.Response.Body,
                    new { error = "Failed to uncomplete item", details = ex.Message },
                    cancellationToken: ct
                );
            }
        }
